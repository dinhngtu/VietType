...
/// </summary>
extern const sorted_map_type<const wchar_t*, const wchar_t*> transitions;
...
extern const sorted_map_type<const wchar_t*, const wchar_t*> transitions_w;
extern const generic_map_type<const wchar_t*, const wchar_t*> transitions_w_q;
// which character in _v that is responsible for ResposTransitionW
extern const sorted_map_type<const wchar_t*, int> respos_w;

extern const generic_map_type<const wchar_t*, const wchar_t*> transitions_v_c2;
extern const generic_map_type<const wchar_t*, const wchar_t*> transitions_v_c2_q;
...
extern const sorted_map_type<wchar_t, const wchar_t*> backconversions;
