...
static _Check_return_ HRESULT GetVirtualDocumentMgr(_In_ ITfDocumentMgr* dim, _COM_Outptr_ ITfDocumentMgr** pdim) {
    ...
    HRESULT_CHECK_RETURN_OUTPTR(hr, pdim, L"dim->QueryInterface failed");
    ...
    HRESULT_CHECK_RETURN_OUTPTR(hr, pdim, L"tcMgr->GetCompartment failed");

    CComVariant v;
    hr = transitoryCompartment->GetValue(&v);
    HRESULT_CHECK_RETURN_OUTPTR(hr, pdim, L"transitoryCompartment->GetValue failed");
...
_Check_return_ HRESULT GetVirtualDocumentContext(_In_ ITfContext* context, _COM_Outptr_ ITfContext** pContext) {
    ...
    HRESULT_CHECK_RETURN_OUTPTR(hr, pContext, L"context->GetStatus failed");
    ...
    HRESULT_CHECK_RETURN_OUTPTR(hr, pContext, L"GetTransitoryParentDocumentMgr failed");
