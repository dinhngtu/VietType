...
SettingsDialog::SettingsDialog(
    DWORD defaultEnabled, DWORD backconvertOnBackspace, const Telex::TelexConfig& telexConfig) {
...
INT_PTR CALLBACK
SettingsDialog::SettingsDialogProc(_In_ HWND hwndDlg, _In_ UINT uMsg, _In_ WPARAM wParam, _In_ LPARAM lParam) {
    ...
    if (uMsg == WM_INITDIALOG) {
        ...
        RECT dlgrect;
        if (GetMonitorInfo(MonitorFromWindow(hwndDlg, MONITOR_DEFAULTTONEAREST), &minfo) &&
        ...
        CheckDlgButton(
            hwndDlg,
            IDC_SETTINGS_DEFAULT_ENABLED,
            instance->Property<IDC_SETTINGS_DEFAULT_ENABLED>() ? BST_CHECKED : BST_UNCHECKED);
        CheckDlgButton(
            hwndDlg, IDC_SETTINGS_OA_UY, instance->Property<IDC_SETTINGS_OA_UY>() ? BST_CHECKED : BST_UNCHECKED);
        CheckDlgButton(
            hwndDlg,
            IDC_SETTINGS_ACCEPT_DD,
            instance->Property<IDC_SETTINGS_ACCEPT_DD>() ? BST_CHECKED : BST_UNCHECKED);
        CheckDlgButton(
            hwndDlg,
            IDC_SETTINGS_BACKSPACE_INVALID,
            instance->Property<IDC_SETTINGS_BACKSPACE_INVALID>() ? BST_CHECKED : BST_UNCHECKED);
        CheckDlgButton(
            hwndDlg,
            IDC_SETTINGS_BACKCONVERT_ON_BACKSPACE,
            instance->Property<IDC_SETTINGS_BACKCONVERT_ON_BACKSPACE>() ? BST_CHECKED : BST_UNCHECKED);
        ...
        case IDOK:
            instance->Property<IDC_SETTINGS_DEFAULT_ENABLED>() =
                IsDlgButtonChecked(hwndDlg, IDC_SETTINGS_DEFAULT_ENABLED) != BST_UNCHECKED;
            instance->Property<IDC_SETTINGS_OA_UY>() = IsDlgButtonChecked(hwndDlg, IDC_SETTINGS_OA_UY) != BST_UNCHECKED;
            instance->Property<IDC_SETTINGS_ACCEPT_DD>() =
                IsDlgButtonChecked(hwndDlg, IDC_SETTINGS_ACCEPT_DD) != BST_UNCHECKED;
            instance->Property<IDC_SETTINGS_BACKSPACE_INVALID>() =
                IsDlgButtonChecked(hwndDlg, IDC_SETTINGS_BACKSPACE_INVALID) != BST_UNCHECKED;
            instance->Property<IDC_SETTINGS_BACKCONVERT_ON_BACKSPACE>() =
                IsDlgButtonChecked(hwndDlg, IDC_SETTINGS_BACKCONVERT_ON_BACKSPACE) != BST_UNCHECKED;
